...
public class TapEmailProcess {
                            ...
                            if (insertPending) {
                                ...
                                if (checkAttachment) {
                                    ...
                                    for (BodyPart bodyPart : bodyParts) {
                                        ...
                                        boolean resultImport = ImportEmailTap.importData(attachmentContent, ipDb, user, password, tableImport, emailConfig.getEmailConfigId());
                                        if (resultImport) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(checkTime){
            ...
            logger.info("Tien trinh quet email tap bat dau");
            TapEmailProcess();
