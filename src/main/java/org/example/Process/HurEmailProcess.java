...
public class HurEmailProcess {
                            ...
                            if (insertPending) {
                                ...
                                if (checkAttachment) {
                                    ...
                                    for (BodyPart bodyPart : bodyParts) {
                                        ...
                                        boolean resultImport = ImportEmailHur.importData(attachmentContent,  emailConfig.getEmailConfigId());
                                        if (resultImport) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        timer.schedule(new HurEmailProcess.MyTask(), 0, h * 36000000 + m * 60000 + s * 1000);
    }
}